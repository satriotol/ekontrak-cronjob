...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('jadwal_per_tender_spses', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('kd_lelang')->nullable();
            $table->bigInteger('kd_tahapan')->nullable();
            $table->longText('tahapan')->nullable();
    ...
    {
        Schema::dropIfExists('jadwal_per_tender_spses');
    }
};
