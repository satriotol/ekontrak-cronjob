...
class HomeController extends Controller
{
    ...
    {
        $responses = Http::timeout(600)->accept('application/json')->get('https://isb.lkpp.go.id/isb/api/fc667e09-d544-4d1c-ab5d-2801b2b29205/json/736987857/Ecat-PaketEPurchasing/tipe/4:12/parameter/' . $year . ':D129');
