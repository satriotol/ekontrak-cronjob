...
class NonTenderEkontrakBapBastSpseController extends Controller
{
    ...
    {
        $responses = Http::accept('application/json')->get('https://inaproc.lkpp.go.id/isb/api/fc68fcf5-0e8d-493e-91c8-0413fe71025a/json/736987894/NonTenderEkontrakBAPbastSPSE/tipe/4:4/parameter/' . $year . ':108');
